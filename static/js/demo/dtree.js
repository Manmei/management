...
function dTree(objName) {
    ...
    this.icon = {
        root: '../../static/img/dtree/base.gif',
        folder: '../../static/img/dtree/folder.gif',
        folderOpen	: '../../static/img/dtree/folderopen.gif',
        node: '../../static/img/dtree/page.gif',
        empty: '../../static/img/dtree/empty.gif',
        line: '../../static/img/dtree/line.gif',
        join: '../../static/img/dtree/join.gif',
        joinBottom	: '../../static/img/dtree/joinbottom.gif',
        plus: '../../static/img/dtree/plus.gif',
        plusBottom	: '../../static/img/dtree/plusbottom.gif',
        minus: '../../static/img/dtree/minus.gif',
        minusBottom: '../../static/img/dtree/minusbottom.gif',
        nlPlus: '../../static/img/dtree/nolines_plus.gif',
        nlMinus: '../../static/img/dtree/nolines_minus.gif'
    };
    this.obj = objName;
    this.aNodes = [];
    this.aIndent = [];
